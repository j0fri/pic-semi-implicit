...
protected:
    ...
    virtual void initialiseDiodeA(T dt);
    virtual void initialisePeriodicField(const std::vector<Species<T,2,3>*>& species, T dt);
    virtual void initialiseDiodeField(const std::vector<Species<T,2,3>*>& species, T dt);
    virtual void constructPeriodicAc(T dt);
    virtual void constructDiodeAc(T dt);
    virtual void constructPeriodicC(T dt);
    virtual void constructDiodeC(T dt);
