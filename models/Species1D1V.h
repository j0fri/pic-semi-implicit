...
public:
    ...
    Species1D1V() = delete;
    explicit Species1D1V(const Config<T,1,1>::SpeciesConfig& speciesConfig);
    ...
    void savePositionDistribution(std::ofstream& outputFile, const Field<T, 1, 1> *field) const;
