...
double getRuntimePerStep(double dt, int Np, int Ng, bool exp = false){
    ...
    config.saveConfig.outputFilesDirectory = "./outputs/parallelScaling3/dummy/";
    ...
    std::ifstream dummyRuntimes("./outputs/parallelScaling3/dummy/runtime.txt");
...
int main(int argc, char* argv[]){
    ...
    //Particle-heavy test:
    {
        ...
        std::stringstream ss;
        ss << "./outputs/parallelScaling3/particleHeavy/" << numProcesses << "/";
    ...
    //Balanced test:
    {
        ...
        config.timeConfig.total = steps*0.1;
        std::stringstream ss;
        ss << "./outputs/parallelScaling3/balanced/" << numProcesses << "/";
        config.saveConfig.outputFilesDirectory = ss.str();
    ...
    //Grid-heavy test:
    {
        ...
        config.timeConfig.total = steps*0.1;
        std::stringstream ss;
        ss << "./outputs/parallelScaling3/gridHeavy/" << numProcesses << "/";
        config.saveConfig.outputFilesDirectory = ss.str();
    ...
    //Explicit:
    {
        ...
        config.timeConfig.total = steps*0.1;
        std::stringstream ss;
        ss << "./outputs/parallelScaling3/explicit/" << numProcesses << "/";
        config.saveConfig.outputFilesDirectory = ss.str();
